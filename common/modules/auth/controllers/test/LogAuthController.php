...
use common\modules\auth\search\LogAuthSearch;
use Yii;
use common\libs\activitylog\models\Activity;
use raumau\controllers\RaumauController;
...
class LogAuthController extends RaumauController
{
    /**
     * @inheritdoc
     */
