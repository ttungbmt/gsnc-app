...
use common\modules\auth\behaviors\LogAuth;
 ...
 */
class User extends MyModel implements IdentityInterface, NotifiableInterface
{
    use UserTrait, NotifiableTrait;
...
//        return static::findOne(['access_token' => $token]);
    ...
    {
        return $this->hashPassword ? app('security')->validatePassword($password, $this->password_hash) : $this->password_hash === $password;
    }
    ...
    {
        $this->password_hash = $this->hashPassword ? app('security')->generatePasswordHash($password) : $password;
    }
