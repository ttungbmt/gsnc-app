        ...
        <?php if (!isset($message)): ?>
            ...
            <?= TabularForm::widget([
                ...
                'gridSettings'      => [
                    ...
                    'panel'            => [
                        'heading' => '<h3 class="card-title"><i class="icon-droplet2"></i> Danh sách mẫu nước thải bệnh viện</h3>',
                        'before'  => false,
                        'after'   => false,
                        'footer' => false,
                    ]
    ...
    <script>
        $(function () {
            $('.pagination li a').click(function (e) {
                ...
                let url = '/admin/poi-benhvien-import?type=preview'
                $.ajax({
                    url,
                    type: 'POST',
                    data,
            ...
            $('#btnSubmit').click(function (e) {
                ...
                let url = '/admin/poi-benhvien-import?type=save'
