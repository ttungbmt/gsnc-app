        ...
        <div class="card-header header-elements-inline">
            ...
            <div class="heading-elements">
                ...
                <a class="btn btn-info btn-labeled btn-labeled-left btn-rounded" download="thongke.xls" href="#"
                   onclick="return ExcellentExport.excel(this, 'tbl-thongke', 'Thongke');"> <b><i class="fa fa-download"></i></b>Tải xuống</a>
            </div>
        </div>
        <div class="card-body">
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <?= $form->field($model, 'qcvn_id')->dropDownList(api('dm/qcvn'), ['prompt' => 'Tất cả'])->label('QCVN') ?>
                </div>
                <div class="col-md-3">
