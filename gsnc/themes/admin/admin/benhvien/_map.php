...
<script>
    $(function(){
        ...
        function addMaker (lat, lng) {
            ...
            $('#benhvien-lat').val(lat);
            $('#benhvien-lng').val(lng);
            ...
            marker.on('dragend', function ondragend() {
                ...
                $('#benhvien-lat').val(m.lat);
                $('#benhvien-lng').val(m.lng);
            });
        ...
        function removeMaker() {
            $('#benhvien-lat').val(null);
            $('#benhvien-lng').val(null);
            map.removeLayer(marker)
        }
                ...
                if (status === google.maps.GeocoderStatus.OK) {
                    if (results[1]) {
                        getPlaceDetail(results[1].place_id, function(detail) {
                            $('#benhvien-diachi').val(detail.formatted_address);
                        });
                    } else {
