...
<script>
    $(function(){
        ...
        function addMaker (lat, lng) {
            ...
            $('#vtonhiem-lat').val(lat);
            $('#vtonhiem-lng').val(lng);
            ...
            marker.on('dragend', function ondragend() {
                ...
                $('#vtonhiem-lat').val(m.lat);
                $('#vtonhiem-lng').val(m.lng);
            });
        ...
        function removeMaker() {
            $('#vtonhiem-lat').val(null);
            $('#vtonhiem-lng').val(null);
            map.removeLayer(marker)
        }
                ...
                if (status === google.maps.GeocoderStatus.OK) {
                    if (results[1]) {
                        getPlaceDetail(results[1].place_id, function(detail) {
                            $('#vtonhiem-diachi').val(detail.formatted_address);
                        });
                    } else {
