...
<script>
    $(function(){
        ...
        function addMaker (lat, lng) {
            ...
            $('#poithugomrac-lat').val(lat);
            $('#poithugomrac-lng').val(lng);
            ...
            marker.on('dragend', function ondragend() {
                ...
                $('#poithugomrac-lat').val(m.lat);
                $('#poithugomrac-lng').val(m.lng);
            });
        ...
        function removeMaker() {
            $('#poithugomrac-lat').val(null);
            $('#poithugomrac-lng').val(null);
            map.removeLayer(marker)
        }
                ...
                if (status === google.maps.GeocoderStatus.OK) {
                    if (results[1]) {
                        getPlaceDetail(results[1].place_id, function(detail) {
                            $('#poithugomrac-diachi').val(detail.formatted_address);
                        });
                    } else {
