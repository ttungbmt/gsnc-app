...
<script>
    $(function(){
        ...
        function addMaker (lat, lng) {
            ...
            $('#vtkhaosat-lat').val(lat);
            $('#vtkhaosat-lng').val(lng);
            ...
            marker.on('dragend', function ondragend() {
                ...
                $('#vtkhaosat-lat').val(m.lat);
                $('#vtkhaosat-lng').val(m.lng);
            });
        ...
        function removeMaker() {
            $('#vtkhaosat-lat').val(null);
            $('#vtkhaosat-lng').val(null);
            map.removeLayer(marker)
        }
                ...
                if (status === google.maps.GeocoderStatus.OK) {
                    if (results[1]) {
                        getPlaceDetail(results[1].place_id, function(detail) {
                            $('#vtkhaosat-diachi').val(detail.formatted_address);
                        });
                    } else {
