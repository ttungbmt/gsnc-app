...
<?=$this->render('@common/themes/admin/admin/import/_errors', ['models' => $models])?>

<?php if (isset($message)): ?>
    <div class="card-body" style="padding: 10px">
        <?= Alert::widget([
            'options' => ['class' => 'no-border mb-5'],
            'body'    => $message,
        ]) ?>
    </div>
    <script>
        ...
        <?php if (!isset($message)): ?>
            ...
            <?= TabularForm::widget([
                ...
                'gridSettings'      => [
                    ...
                    'panel'            => [
                        'heading' => '<h3 class="card-title"><i class="icon-puzzle2"></i> Danh sách Vị trí khảo sát</h3>',
                        'before'  => false,
                        'after'   => false,
                        'footer' => false,
                    ]
    ...
    <script>
        $(function () {
            $('.pagination li a').click(function (e) {
                ...
                let url = '/admin/vt-khaosat-import?type=preview'
                $.ajax({
                    url,
                    type: 'POST',
                    data,
            ...
            $('#btnSubmit').click(function (e) {
                ...
                let url = '/admin/vt-khaosat-import?type=save'
