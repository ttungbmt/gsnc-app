...
$this->title = 'Nhập Excel Vị trí ô nhiễm';
...
<div class="alert" style="border: 1px solid rgba(0, 188, 212, 0.52); background-color: white;">
    ...
    <p style="margin-left: 2em">+ Tên vị trí - <b>ten</b></p>
    <p style="margin-left: 2em">+ Loại ô nhiễm - <b>onhiem_id</b></p>
    <p style="margin-left: 2em">+ Ghi chú - <b>ghichu</b></p>
    ...
    <script>
        $(function () {
            ...
            $('#uploadForm').submit(function (e) {
                ...
                l.start()
                const api = postApi('/admin/vt-onhiem-import?type=preview', data)
                api.done(res => {
                    l.stop()
            ...
            $('#btnSaveAll').click(function (e) {
                ...
                const api = postApi('/admin/vt-onhiem-import?type=save-all', data)
                l.start()
                api.done(res => {
                    l.stop()
                    $('#importResp').html(res.html)
