        ...
        <?php if (!isset($message)): ?>
            ...
            <?= TabularForm::widget([
                ...
                'gridSettings'      => [
                    ...
                    'panel'            => [
                        'heading' => '<h3 class="card-title"><i class="icon-puzzle2"></i> Danh sách Vị trí ô nhiễm</h3>',
                        'before'  => false,
                        'after'   => false,
                        'footer' => false,
                    ]
    ...
    <script>
        $(function () {
            $('.pagination li a').click(function (e) {
                ...
                let url = '/admin/vt-onhiem-import?type=preview'
                $.ajax({
                    url,
                    type: 'POST',
                    data,
            ...
            $('#btnSubmit').click(function (e) {
                ...
                let url = '/admin/vt-onhiem-import?type=save'
